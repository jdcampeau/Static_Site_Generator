...
from textnode import TextType, TextNode, text_node_to_html_node, split_nodes_delimiter, split_nodes_image, split_nodes_link, markdown_to_textnode, markdown_to_html_node
...
class TestTextNode(unittest.TestCase):
    ...
    def test_split_links_link_first(self):
        node = TextNode(
            "[The link](https://i.imgur.com/zjjcJKZ.png) comes first in this text",
            TextType.TEXT,
        )
        new_nodes = split_nodes_link([node])
        self.assertListEqual(
            [
                TextNode("The link", TextType.LINK, "https://i.imgur.com/zjjcJKZ.png"),
                TextNode(" comes first in this text", TextType.TEXT),
            ],
            new_nodes,
        )
    ...
    def test_markdown_to_textnode(self):
        ...
        nodes = markdown_to_textnode(markdown_text) 
        expected_output = [
